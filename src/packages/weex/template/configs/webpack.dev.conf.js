const commonConfig = require('./webpack.common.conf');  //导入webpack的默认配置
//webpack的配置合并工具
const webpackMerge = require('webpack-merge'); // used to merge webpack configs  
// tools
const chalk = require('chalk');   //翻译为 粉笔 颜色设置
const path = require('path');     // 导入路径库
const webpack = require('webpack'); //导入webpack
const ip = require('ip').address(); //获得当前的ip

/**
 * Webpack Plugins
 */
const HtmlWebpackPlugin = require('html-webpack-plugin'); //导入html webpack的插件
const ScriptExtHtmlWebpackPlugin = require('script-ext-html-webpack-plugin'); //preload prefetch defer async
const FriendlyErrorsPlugin = require('friendly-errors-webpack-plugin')  //友好的错误插件
const portfinder = require('portfinder')  //寻找端口的插件

const config = require('./config'); //导入config文件
const utils = require('./utils'); //导入utils文件
const helper = require('./helper'); //导入helper方法
